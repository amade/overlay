...
IUSE="aac +adplug alsa bs2b cdda cue dbus ffmpeg flac fluidsynth gnome http gtk gtk3 jack
...
RDEPEND="app-arch/unzip
	...
	dbus? ( || ( >=dev-libs/glib-2.32.2[utils] dev-util/gdbus-codegen ) )
